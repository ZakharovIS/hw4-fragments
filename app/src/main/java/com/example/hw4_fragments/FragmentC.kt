...
import com.example.hw4_fragments.databinding.FragmentCBinding
...
class FragmentC : Fragment() {
    ...
    override fun onCreateView(
        ...
        requireActivity().title = FragmentC::class.java.simpleName
        ...
        binding.buttonToFragmentD.setOnClickListener {
            parentFragmentManager.commit {
                ...
                addToBackStack(FragmentD::class.java.simpleName)
            }
        }
